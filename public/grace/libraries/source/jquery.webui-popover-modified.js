    ...
    WebuiPopover.prototype = {
        ...
        init: function() {
            ...
            if (this.getTrigger() === 'click') {
                ...
                this.$element
                    /*.off('mouseenter mouseleave click')*/ //added by AK. this is to prevent this pluging removing the default hovering behaviour
        ...
        */
        ...
        show: function() {
        	//added by AK. creates a callback to check if popups are globally switched off.
        	if(this.options.showCheck != null && this.options.showCheck() == false)
        		return;
        	
        	//added by AK. this is to prevent showing popup after clicking and when the layout changes.
